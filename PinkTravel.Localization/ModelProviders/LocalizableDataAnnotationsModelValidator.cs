...
namespace PinkTravel.Localization.ModelProviders
{
    public class LocalizableDataAnnotationsModelValidator : ModelValidator
    {
        ...
        public LocalizableDataAnnotationsModelValidator(ModelValidator innerValidator, ModelMetadata metadata, ControllerContext controllerContext) : base(metadata, controllerContext)
        {
